<template>
	<div class="xdChart">
		<top title="护士陪诊服务运营管理" theUrl="order" theType="chart"></top>
		<Row :gutter="40">
			<i-col span='8'>
	...
	export default{
		...
		data(){
			return {
				...
				taocan: [
					{"name":"156元/次","value": 1596},
					{"name":"286元/次","value": 1775},
					{"name":"599元/次","value": 708},
					{"name":"899元/次","value": 452}
				],
				hushi: {
					xAxis: ['南京','重庆','天津','上海','杭州'],
					data: [446,155,256,337,109]
				},
				huanzhe: {
					xAxis: ['北京','南京','重庆','杭州','天津'],
					data: [1356,1973,667,1143,577]
				},
				doctorTitle: {
					xAxis: ['1月','2月','3月','4月','5月','6月','7月','8月','9月','10月','11月','12月'],
					data: [27,26,38,32,28,39,31,25,28,23,28,31]
				},
				doctorTitle2: {
					xAxis: ['1月','2月','3月','4月','5月','6月','7月','8月','9月','10月','11月','12月'],
